...
if [ "$EUID" -ne 0 ]; then
    ...
    # ---->>>> Instalar rust (se já não estiver instalado)
    show_progress "Verificando instalação do Rust..."
    ...
    # ---->>>> Copiar e configurar os executáveis
    show_progress "Copiando e configurando executáveis..."
    cp /home/ubuntu/RustyProxyOnly/RustyProxy /opt/rustyproxy/proxy || error_exit "Falha ao copiar RustyProxy"
    cp /home/ubuntu/RustyProxyOnly/rusty_menu /opt/rustyproxy/menu || error_exit "Falha ao copiar rusty_menu"
    increment_step
    ...
    # Não remover o diretório RustyProxyOnly, pois ele contém os executáveis que acabamos de copiar
