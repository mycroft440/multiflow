...
install_socks5_proxy() {
    ...
    # Verificar se existe Cargo.toml para compilar
    if [[ -f "$SCRIPT_DIR/Cargo.toml" ]]; then
        ...
        warning_msg "Arquivo Cargo.toml não encontrado. Pulando instalação do SOCKS5."
    fi
...
success_msg "Instalação do MultiFlow concluída com sucesso!"
info_msg "Para acessar o menu principal, execute: sudo ./menu.sh"
